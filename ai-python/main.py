...
for the duration of processing and is always deleted afterward — this
process never persists video content to disk beyond a single request.
"""
...
SAMPLE_FPS = 10
SUPPORTED_EXERCISE_TYPES = {"PUSH_UP", "SIT_AND_REACH"}
